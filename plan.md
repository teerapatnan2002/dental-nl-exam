...
## 9. สิ่งที่ยังต้องตรวจ (Batch 6 เป็นต้นไป)

### สถานะปัจจุบัน:
- **ตรวจแล้วสะสม:** 103 ข้อ (กฎหมาย) + 195 ข้อ (Batch 1) + 250 ข้อ (Batch 2) + 250 ข้อ (Batch 3) + 245 ข้อ (Batch 4) + 250 ข้อ (Batch 5) = **1,293 ข้อ** (1,207 unique IDs)
- **แก้ไขใน DB สะสม:** **81 ข้อ**
- **คงเหลือยังไม่ได้ตรวจ:** **1,087 ข้อ**

### จำนวนข้อที่ยังไม่ได้ตรวจตามหมวด:
| หมวด | ตรวจแล้ว / ทั้งหมด | คงเหลือ | สถานะ |
|------|-------------------|---------|-------|
| วิทยาการวินิจฉัยและเวชศาสตร์ช่องปาก (Oral Med) | 112 / 359 | 247 | รอตรวจใน Batch 6+ |
| ทันตกรรมสำหรับเด็ก (Pedo) | 124 / 348 | 224 | รอตรวจใน Batch 6+ |
| ทันตกรรมประดิษฐ์ (Prostho) | 114 / 240 | 126 | รอตรวจใน Batch 6+ |
| ศัลยศาสตร์ช่องปาก (Surgery) | 104 / 236 | 132 | รอตรวจใน Batch 6+ |
| วิทยาเอ็นโดดอนต์ (Endo) | 102 / 217 | 115 | รอตรวจใน Batch 6+ |
| ปริทันตวิทยา (Perio) | 105 / 202 | 97 | รอตรวจใน Batch 6+ |
| ทันตกรรมบูรณะ/หัตถการ (Operative) | 111 / 188 | 77 | รอตรวจใน Batch 6+ |
| ทันตกรรมชุมชน (Community) | 120 / 180 | 60 | รอตรวจใน Batch 6+ |
| กฎหมายและจรรยาบรรณ (Law) | 133 / 133 | **0** | **✅ เสร็จสมบูรณ์ 100%** |
| ทันตกรรมจัดฟัน (Ortho) | 107 / 107 | **0** | **✅ เสร็จสมบูรณ์ 100%** |
| ทันตกรรมบดเคี้ยว/TMD (Occlusion) | 74 / 74 | **0** | **✅ เสร็จสมบูรณ์ 100%** |
| ไม่ระบุหมวด (None) | 0 / 9 | 9 | รอตรวจ |
