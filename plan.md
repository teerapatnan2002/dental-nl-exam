...
## 9. สิ่งที่ยังต้องตรวจ (Batch 9 — Final Batch สู่ 100%)

### สถานะปัจจุบัน:
- **ตรวจแล้วสะสม:** 103 ข้อ (กฎหมาย) + 195 ข้อ (Batch 1) + 250 ข้อ (Batch 2) + 250 ข้อ (Batch 3) + 245 ข้อ (Batch 4) + 250 ข้อ (Batch 5) + 250 ข้อ (Batch 6) + 250 ข้อ (Batch 7) + 250 ข้อ (Batch 8) = **2,043 ข้อ** (**1,957 unique IDs** คิดเป็น **85.3%**)
- **แก้ไขใน DB สะสม:** **149 ข้อ** (+ ปรับหมวดวิชาสมบูรณ์)
- **คงเหลือยังไม่ได้ตรวจในทั้งฐานข้อมูล:** **337 ข้อ** (มุ่งสู่ Batch 9 ปิด 100%)

### จำนวนข้อที่ยังไม่ได้ตรวจตามหมวด:
| หมวด | ตรวจแล้ว / ทั้งหมด | คงเหลือ | สถานะ |
|------|-------------------|---------|-------|
| วิทยาการวินิจฉัยและเวชศาสตร์ช่องปาก (Oral Med) | 171 / 364 (47.0%) | 193 | รอตรวจใน Batch 9 (Final) |
| ทันตกรรมสำหรับเด็ก (Pedo) | 204 / 348 (58.6%) | 144 | รอตรวจใน Batch 9 (Final) |
...
| กฎหมายและจรรยาบรรณ (Law) | 134 / 134 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100%** |
