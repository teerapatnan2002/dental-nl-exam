...
### สรุปการแก้ไขใน Batch 7 (250 ข้อ — 2026-09-06)
...
### สรุปการแก้ไขใน Batch 8 (250 ข้อ — 2026-09-06)

| ID | เดิม | แก้เป็น | หมวด | เหตุผลทางวิชาการ |
|----|------|---------|------|-----------------|
| 2201 | d | a | Endo | การเกี่ยวรื้อ gutta-percha ใน retreatment เครื่องมือมือที่ปลอดภัยและมีประสิทธิภาพสูงสุดคือ Hedstrom file (H-file); C-file มีไว้ทะลวง calcified canal เท่านั้น |
| 1852 | 2 | 3 | Endo / Perio | ขูดหินปูนซี่ 47M (Mesial surface ของ molar) ใช้ Gracey no. 11/12; Gracey 3/4 เป็น anterior curette |
| 1815 | 1 | 3 | Endo / Pedo | วัสดุทำ Pulpotomy ในฟันน้ำนม 74: Ferric sulfate 15.5% เป็นมาตรฐาน; Ca(OH)2 ในฟันน้ำนมทำให้เกิด internal resorption สูงมากห้ามใช้ |
| 1816 | 3 | 1 | Endo / Pedo | เด็กกัดริมฝีปากเป็นแผลใหญ่หลังยาชา (Lip biting trauma): เป็น traumatic ulcer ให้ Paracetamol บรรเทาปวดและทาวาสลีน ไม่ต้องจ่าย Amoxicillin |
| 1817 | 2 | 1 | Endo / Pedo | 74, 75 ผุทะลุ pulp ไม่มีอาการปวด ไม่มีรอยโรคปลายราก: รักษาด้วย 74, 75 Pulpotomy |
| 2206 | b | a | Prostho | Floor of mouth (FOM) 6 mm: มีข้อห้ามใช้ Lingual bar (ต้องการอย่างน้อย 7-8 mm) ต้องใช้ Lingual plate |
| 2205 | b | a | Prostho | RPD ล่างวาง indirect retainer บน 34 (First premolar) ซึ่งรากแข็งแรง; ห้ามวางบน 32 (Lateral incisor) ซึ่งรากสั้นไม่แข็งแรง |
| 2110 | E | A | Prostho | ผู้ป่วย ITP ขากรรไกรล่างมีฟัน canine-to-canine บันทึก Centric relation ต้องใช้ Bite block บนและล่าง เพื่อรองรับความสูงแนวดิ่ง |
| 2142 | B | A | Prostho | ซี่ 35 ทำ Crown lengthening มี ferrule 2-3 mm, ซี่ 36 หายไป: ทางเลือกมาตรฐานคือ 35 PCC with 36 implant (สอดคล้องกับข้อ 2144) |
| 2182 | ไม่สามารถระบุได้ | a | Endo | ซี่ 46 มี sinus tract แต่ PD 3-4 mm ทุกตำแหน่งและไม่โยก (Primary endo lesion): พยากรณ์โรคเป็น Favorable |
| 2076 | D | B | Surgery | ผู้ป่วยฉีด Prolia (Denosumab) ทุก 6 เดือน (ม.ค./ก.ค.) ถอนฟัน 46 ปลอดภัยที่สุดในเดือนพฤษภาคม (เดือนที่ 5) ซึ่งฤทธิ์ยับยั้ง osteoclast ต่ำสุด |
| 2023 | B | A | Surgery | วัตถุหล่นลงคอ หมดสติ คลำชีพจรไม่ได้: AHA C-A-B เริ่มด้วย Chest compression ทันที ห้ามทำ Heimlich ในคนหมดสติ |
| 2051 | D | C | Surgery | เอา alginate ออกจากคอแล้ว หมดสติ คลำชีพจรไม่ได้: ผู้ป่วยหัวใจหยุดเต้น ต้องเริ่ม Chest compression ทันที |
| 1201 | 2 | 1 | Pedo | เด็ก 20 kg TOF รับประทานยาได้: IE Prophylaxis อันดับหนึ่งคือ Amoxicillin 1000 mg PO (50 mg/kg) |
| 1447 | E | A | Pedo | IE Prophylaxis ในเด็ก TOF 20 kg (ข้อคู่ขนาน 1201): ให้ Amoxicillin 1000 mg PO |
| 1448 | D | C | Pedo | เด็ก TOF ซี่ 64 ผุทะลุ pulp มีรอยโรคปลายราก ห้ามทำ Pulpotomy เด็ดขาด ต้องทำ 64 Pulpectomy, 65 Extraction |
| 1485 | E | A | Pedo | รอยโรคสีฟันที่รักษาด้วย Resin infiltration (Icon) คือ Fluorosis / White spot lesion |
| 1486 | D | A | Pedo | สาเหตุของ Fluorosis (ข้อต่อเนื่อง 1485): ได้รับ Fluoride ตอนสร้างฟันมากไป (Chronic excessive fluoride during amelogenesis) |
| 951 | D | A | Oral Med / Perio | ผู้ป่วยมี furcation involvement ซี่ 37 ซอกฟันกว้าง: แนะนำ Interproximal brush (แปรงซอกฟัน); ห้ามแนะนำ Toothpick |
| 946 | B | E | Oral Med / Surgery | ฝี Canine space (จากฟัน 24/เขี้ยวบน) ติดต่อโดยตรงในระนาบใบหน้าสู่ Buccal space; Pterygomandibular space อยู่ในขากรรไกรล่าง |
| 943 | E | D | Pedo | กั้นแยก 84, 85 โดยมี 46 ขึ้นบางส่วน: ใส่ Clamp no. 8A ที่ซี่ 46 (Anchor tooth) ซึ่งมีปากจับลึกใต้เหงือก |
| 961 | E | A | Pedo | เด็ก 4 ขวบ ปวดฟันกลางคืนและเคี้ยวเจ็บ 75 ผุทะลุโพรงประสาท: วินิจฉัย Irreversible pulpitis with symptomatic apical periodontitis |
...
| 1924 | 5 | 5 | Law / Ethics | ย้ายหมวดวิชาจาก ศัลยศาสตร์ช่องปาก สู่ กฎหมายและจรรยาบรรณ (ข้อบังคับจรรยาบรรณ พ.ศ. 2538 หมวด 5) |

---

### สรุปการแก้ไขใน Batch 9 (337 ข้อ — 2026-09-06) [The Final Batch — 100% Complete!]

| ID | เฉลยเดิม | เฉลยใหม่ | หมวดวิชา | เหตุผลทางวิชาการและแหล่งอ้างอิง |
| :---: | :---: | :---: | :---: | :--- |
| **1155** | B | **A** | Oral Med | ผู้ป่วยหญิง 60 ปี แสบกระพุ้งแก้มเวลาทานเผ็ด ตรวจพบ white striae สองข้างของ buccal mucosa คือ Oral Lichen planus (Wickham striae) (Neville) |
| **1157** | B | **A** | Oral Med | จุลพยาธิวิทยาของ Oral Lichen Planus คือ Band of lymphocyte infiltration ใต้ basement membrane (Neville) |
| **1530** | A | **E** | Pedo | เด็ก 8 ขวบ 85 ผุเสมอเหงือก distal root ละลายเกือบถึง furcation มีหน่อ 45 จ่ออยู่: ข้อห้ามทำ Pulpotomy ต้องทำ Extraction (AAPD) |
| **1532** | E | **A** | Pedo | 85 ติดเชื้อปลายราก/ง่ามรากส่งผลต่อ 45 ทำให้เกิด Enamel hypoplasia (Turner's hypoplasia / Turner's tooth) (McDonald/Neville) |
| **1669** | 2 | **1** | Pedo | 65 Pulpectomy ด้วย Vitapex ล้นปลายราก: Vitapex ดูดซึมได้เองใน 1-2 เดือน ห้ามรื้อทำใหม่ ให้ Recall 6 months เพื่อ x-ray (AAPD) |
| **1716** | 2, 4 | **2** | Oral Med | ปัจจัยเสริมเฉพาะที่ (local factor) หลักของ Pregnancy tumor (Pyogenic granuloma) คือ ปริมาณหินปูนเหนือเหงือก (Dental calculus and plaque) (Carranza) |
| **1802** | 2 | **3** | Oral Med | Trigeminal neuralgia ตรวจพบ HLA-B*15:02 ห้ามใช้ Carbamazepine และ Oxcarbazepine เด็ดขาด ทางเลือกที่ปลอดภัยคือ Gabapentin (CPIC/FDA) |
| **1826** | 3, 4, 5 | **3** | Oral Med | ผลโดยตรงของ hyposalivation ต่อโรคปริทันต์คือ Change in biofilm (dysbiosis); buffer capacity ส่งผลต่อ caries (Carranza) |
| **1902** | 1, 3, 4 | **4** | Surgery | คำสั่งแรกรับผู้ป่วยใน (Order for one day) ที่ admit ด้วยติดเชื้อบวมคาง คือ Lab investigation test (CBC, CXR) |
| **2084** | E | **D** | Oral Med | ผู้ป่วย Trigeminal neuralgia หลังทาน Carbamazepine เกิดแผลริมฝีปากบวมและมี hemorrhagic crusting ทั่วปากบนล่าง คือ Erythema Multiforme (Neville) |
| **2103** | A | **C** | Pedo | เด็ก 20 kg ยาชา Lidocaine MRD (4.4 mg/kg = 88 mg = 4.4 mL) ฉีดไปแล้ว 1.8 mL เติมได้อีกสูงสุด 2.6 mL (AAPD) |
| **2114** | B | **A** | Oral Med | Traumatic ulcer ที่ลิ้นจากขอบฟันกรามแตกคม รักษาลดอักเสบและระงับปวดด้วย 0.1% Triamcinolone acetonide in Orabase |
| **2117** | B | **A** | Pedo | เด็ก 6 ขวบ VSD (เสี่ยง IE) ฟันน้ำนม 65 ติดเชื้อในโพรงประสาท ข้อห้ามทำ Pulpectomy ต้องทำ Extraction ภายใต้ IE prophylaxis (AAPD/AHA) |
| **2150** | 1 | **A** | Pedo | พฤติกรรมคุณแม่ขอเข้ามาประกบและถามหมอตลอดเวลา คือ Over anxiety ของผู้ปกครองในทันตกรรมเด็ก |
| **2166** | b | **c** | Pedo | เด็ก 4 ขวบ มะเร็งเม็ดเลือดขาว ALL, ANC=450, เกล็ดเลือด 80,000 ฟัน 54 ผุทะลุ pulp: รักษาด้วย Antibiotic prophylaxis and extraction (AAPD Oncology) |
| **2170** | d | **b** | Oral Med | นิ่วท่อน้ำลาย (Sialolithiasis) ใน Wharton's duct ที่พื้นช่องปาก ตรวจร่างกายทางคลินิกด้วยการ คลำ submandibular salivary gland (Bimanual palpation) |
| **2179** | e | **d** | Pedo | เด็ก 5 ขวบ 85 ปวดกลางคืนและมี furcation radiolucency บ่งชี้การติดเชื้อลามลงราก รักษาด้วย Pulpectomy |
| **2180** | c | **d** | Pedo | เด็ก 20 kg ยาแก้ปวด Paracetamol 10-15 mg/kg คือ 250 mg: สั่ง Paracetamol 250 mg 1 tsp q4-6h (ยาน้ำสูตร Forte 250 mg/5 mL) |
| **2181** | b | **e** | Pedo | เด็ก 5 ขวบ ห้ามใช้น้ำยาบ้วนปากฟลูออไรด์ ฟลูออไรด์ทำเฉพาะที่ในคลินิกที่ปลอดภัยและมีประสิทธิภาพคือ 5% NaF Varnish (AAPD/ADA) |
| **2198** | ไม่สามารถระบุได้ | **1** | Oral Med | Traumatic ulcer จาก mouth gag รักษาลดอักเสบเฉพาะที่ด้วย 0.1% Triamcinolone acetonide in Orabase |
| **2208** | b | **e** | Pedo | Mesiodens (ฟันเกินกึ่งกลางบน) เกิดจากความผิดปกติในระยะ Initiation / Proliferation stage ของการสร้างฟัน |

---

## 9. สถานะการตรวจสอบทั้งโครงการ (100.0% Complete! 🎉)

### สรุปผลสัมฤทธิ์โครงการ:
- **ตรวจแล้วสะสม:** **2,293 / 2,293 ข้อ (100.0% ครบถ้วนบริบูรณ์ทั้งฐานข้อมูล)**
- **แก้ไขใน DB สะสม:** **170 ข้อ** (+ ปรับหมวดวิชาสมบูรณ์ครบถ้วน 33 ข้อ)
- **คงเหลือยังไม่ได้ตรวจ:** **0 ข้อ (0.0%)**

### ตารางสถานะรายหมวดวิชาสมบูรณ์ 100%:
| หมวด | ตรวจแล้ว / ทั้งหมด | คงเหลือ | สถานะ |
|------|-------------------|---------|-------|
| กฎหมายและจรรยาบรรณ (Law & Ethics) | 134 / 134 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100%** |
...
| วิทยาเอ็นโดดอนต์ (Endo) | 218 / 218 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100% (Batch 8)** |
| ทันตกรรมประดิษฐ์ (Prostho) | 237 / 237 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100% (Batch 8)** |
| ศัลยศาสตร์ช่องปาก (Surgery) | 236 / 236 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100% (Batch 8)** |
| ทันตกรรมสำหรับเด็ก (Pedo) | 348 / 348 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100% (Batch 9)** |
| วิทยาการวินิจฉัยและเวชศาสตร์ช่องปาก (Oral Med) | 364 / 364 (100.0%) | **0** | **✅ เสร็จสมบูรณ์ 100% (Batch 9)** |
| **รวมทั้งสิ้น (Grand Total)** | **2,293 / 2,293 (100.0%)** | **0** | **🏆 เสร็จสมบูรณ์ 100% ทุกข้อในระบบ** |

---

## 10. สรุปกระบวนการตรวจสอบและเครื่องมือ
